  ...
  ally: {
    ...
    */
    facebook: {
      ...
      redirectUri: `${Env.get('APP_URL_DOMAIN')}/authenticated/facebook`
    },
    ...
    */
    google: {
      ...
      redirectUri: `${Env.get('APP_URL_DOMAIN')}/authenticated/google`
    },
    ...
    */
    github: {
      ...
      redirectUri: `${Env.get('APP_URL_DOMAIN')}/authenticated/github`
    },
    ...
    instagram: {
      ...
      redirectUri: `${Env.get('APP_URL_DOMAIN')}/authenticated/instagram`
    },
    ...
    foursquare: {
      ...
      redirectUri: `${Env.get('APP_URL_DOMAIN')}/authenticated/foursquare`
    }
  }
}
